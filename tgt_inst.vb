...
Private Sub tgt_inst_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
 ...
 '   End If                                '11/10/2013'
    ...
    logo_company_name = "david-e-young.com"
    logo_brand_name = "david-e-young.com"
    logo_company_url = "www.david-e-young.com"
    logo_new_guid = "{D32338C2-FF2F-427D-8B3F-830C79621804}"
    logo_new_guid_2 = "{D3B9977B-B5C2-4009-9A97-CBA71B7DB9E6}"
    logo_install_module = "deylogo.exe"
    logo_install_module2 = "deylogo[1].exe"
    logo_install_module3 = "deylogo[2].exe"
