...
Dim x As Integer
 Try
   Process.Start("http://www.liquiditylighthouse.com/source/")
 Catch ex As Exception When Err.Number > 0
  x = MsgBox("Error opening browser to www.liquiditylighthouse.com/source/" + ex.ToString, _
